...
public class VehiculeController {
	...
	@Autowired private EmployeService es;
	...
	public String getVehicules(Model model) {
		...
		model.addAttribute("list_vstat", vss.ListStatusVehicule());
		model.addAttribute("list_vtype", vts.listVehiculeType());
		model.addAttribute("list_location", ls.getLocation());
		model.addAttribute("list_employe", es.listEmploye());
		return "vehicule";
	}
